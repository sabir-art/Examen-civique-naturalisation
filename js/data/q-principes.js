...
const symboles = [
  ...
  },
  {
    ...
    c: [
      "Parce que des volontaires venus de Marseille l'ont chanté en arrivant à Paris",
      "Parce que son auteur est né à Marseille",
      "Parce qu'il a été composé dans le port de Marseille",
      "Parce que Marseille fut la première capitale de la République",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      ...
      "Le pouvoir appartient à la majorité",
  ...
  },
  {
    ...
    c: [
      ...
      "libre, unie, prospère et souveraine",
      "fédérale, laïque et démocratique",
      "parlementaire, chrétienne et sociale",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "Chacun peut agir comme il l'entend dans le respect de la loi et de la liberté d'autrui",
      "Chacun peut faire ce qu'il veut sans aucune limite",
      "La liberté est réservée aux citoyens français",
      "La liberté est accordée par le maire de la commune",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "Tous les citoyens ont les mêmes droits et les mêmes devoirs devant la loi",
      "Tous les citoyens perçoivent le même revenu",
      "Tous les citoyens exercent le même métier",
      "Tous les citoyens paient exactement le même montant d'impôt",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "La solidarité et l'entraide entre les membres de la société",
      "L'obligation d'appartenir à une association",
      "La préférence donnée aux membres de sa famille",
      "L'appartenance à une même religion",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "un principe constitutionnel que la loi doit favoriser",
      "une simple recommandation sans valeur juridique",
      "un objectif réservé au secteur public",
      "une règle qui ne s'applique qu'au droit de vote",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "Au fronton des mairies, des écoles et des bâtiments publics",
  ...
  },
  {
    ...
    c: [
      "La Liberté assise, tenant un faisceau de licteur",
      "Le portrait du président en exercice",
  ...
  },
  {
    ...
    c: [
      "l'union des citoyens et l'autorité de la justice",
  ...
  },
  {
    ...
    c: [
      "Le territoire et le peuple français forment un ensemble unique, sans partage de souveraineté",
      "Le territoire ne peut pas être divisé en communes",
      "Les régions n'ont aucune compétence",
      "La France ne peut pas signer de traités",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "Elle garantit la solidarité et cherche à réduire les inégalités",
      "Elle impose une seule classe sociale",
      "Elle interdit la propriété privée",
      "Elle organise la vie associative obligatoire",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "Le coq est inscrit dans la Constitution comme emblème officiel",
      "Le drapeau tricolore est l'emblème national",
      "La Marseillaise est l'hymne national",
      "Marianne représente la République",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "la fête du Travail, jour férié et chômé",
      "la fête nationale",
      "la journée de l'Europe",
      "un jour ouvré comme un autre",
    ],
    a: 0,
...
const laicite = [
  ...
  },
  {
    ...
    c: [
      ...
      "L'obligation de pratiquer une religion reconnue",
      "La reconnaissance de quatre cultes officiels",
  ...
  },
  {
    ...
    c: [
      ...
      "il faut être athée pour être français",
      "seule la religion majoritaire est autorisée",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "aux agents du service public dans l'exercice de leurs fonctions",
      "à tous les habitants, dans la rue comme chez eux",
      "aux seuls élus locaux",
      "aux usagers des services publics uniquement",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "L'interdiction des signes religieux ostensibles pour les élèves des écoles, collèges et lycées publics",
      "L'interdiction des signes religieux dans la rue",
      "L'interdiction des cours d'histoire des religions",
      "L'obligation pour les élèves de suivre un enseignement religieux",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      ...
      "L'interdiction du port de la croix",
      "L'obligation de retirer son chapeau à la mairie",
      "L'interdiction des processions religieuses",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "Non, la loi l'interdit dans les écoles, collèges et lycées publics",
      "Oui, sans aucune restriction",
      "Oui, avec l'accord du professeur principal",
      "Oui, uniquement pendant les récréations",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "peut porter un signe religieux, mais doit respecter les règles de fonctionnement du service",
      "doit obligatoirement retirer tout signe religieux",
      "ne peut pas entrer s'il porte un signe religieux",
      "doit déclarer sa religion à l'accueil",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "Elles peuvent avoir un caractère propre, mais doivent respecter la liberté de conscience des élèves",
      "Elles sont soumises aux mêmes règles que les écoles publiques",
      "Elles n'ont aucune obligation vis-à-vis de l'État",
      "Elles sont interdites en France",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "Oui, si le règlement intérieur le prévoit de façon générale et justifiée par la nature des tâches",
      "Non, jamais",
      "Oui, librement et sans motif",
      "Uniquement si l'entreprise a un lien avec l'État",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "Oui, la critique des idées et des religions est permise, mais l'injure et l'incitation à la haine envers les personnes sont punies",
      "Non, toute critique d'une religion est un délit",
      "Oui, sans aucune limite",
      "Uniquement dans le cadre universitaire",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "Non, il n'existe pas de délit de blasphème",
      "Oui, il est puni d'une amende",
  ...
  },
  {
    ...
    c: [
      "Elle renforce la neutralité du service public et la lutte contre le séparatisme",
      "Elle supprime la loi de 1905",
      "Elle rend l'instruction religieuse obligatoire",
      "Elle interdit les associations cultuelles",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "Non, certains sont civils comme le 14 juillet, le 1er mai, le 8 mai et le 11 novembre",
      "Oui, tous sont d'origine chrétienne",
      "Non, aucun n'a d'origine religieuse",
      "Oui, sauf le 25 décembre",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "Non, la neutralité du service public l'interdit",
      "Oui, s'il est discret",
      "Oui, avec l'accord de son supérieur",
      "Oui, en dehors des heures d'affluence",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "le droit de croire, de ne pas croire et de changer de religion",
      "le droit d'imposer sa religion à sa famille",
      "le droit de ne pas respecter la loi au nom de sa foi",
      "le droit d'exiger un service public spécifique",
    ],
    a: 0,
