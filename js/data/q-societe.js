...
const sante = [
  {
    ...
    c: ["Un système de protection collective qui rembourse les soins et verse des aides", "Une assurance privée facultative souscrite auprès d'une mutuelle de son choix", "Un dispositif réservé aux retraités et aux personnes âgées", "Un service de police municipale chargé de la santé"],
    a: 0,
  ...
  },
  {
    ...
    c: ["Le médecin que l'on déclare pour coordonner ses soins et être mieux remboursé", "Un médecin de garde imposé par la mairie de votre commune de résidence", "Un médecin réservé aux urgences", "Un médecin obligatoire pour les enfants uniquement"],
    a: 0,
  ...
  },
  {
    ...
    c: ["La CAF (Caisse d'allocations familiales)", "La CPAM, caisse d'assurance maladie", "France Travail", "L'URSSAF"],
    a: 0,
  ...
  },
  {
    ...
    c: ["Bénéficier d'une complémentaire santé gratuite ou peu coûteuse selon ses revenus", "Obtenir un logement social dans la commune de son choix", "Bénéficier d'une retraite anticipée dès l'âge de cinquante-cinq ans", "Être exonéré d'impôts pendant les trois premières années"],
    a: 0,
  ...
  },
  {
    ...
    c: ["est garanti à toute personne, quelle que soit sa situation", "est réservé aux assurés sociaux", "nécessite une autorisation préalable", "est payant d'avance dans tous les cas, sans exception"],
    a: 0,
  ...
  },
  {
    ...
    c: ["Un revenu minimum versé sous conditions aux personnes sans ressources", "Une allocation versée aux personnes qui ont perdu leur emploi", "Une aide au financement du permis de conduire des jeunes", "Une pension versée après une carrière complète"],
    a: 0,
...
const ecole = [
  ...
  },
  {
    ...
    c: ["Le diplôme national du brevet", "Le baccalauréat, général ou professionnel", "Le CAP", "La licence"],
    a: 0,
  ...
  },
  {
    ...
    c: ["Oui, notamment en élisant des représentants au conseil d'école ou d'administration", "Non, l'école est l'affaire des seuls enseignants et du chef d'établissement", "Oui, uniquement s'ils sont français", "Oui, uniquement s'ils paient une cotisation"],
    a: 0,
  ...
  },
  {
    ...
    c: ["Oui, la loi du 11 février 2005 garantit son inscription et un accompagnement adapté", "Non, il doit être accueilli dans un établissement spécialisé, prévu pour cela", "Oui, mais uniquement à l'école maternelle", "Cela dépend de la décision du directeur"],
    a: 0,
  ...
  },
  {
    ...
    c: ["Oui, notamment l'allocation de rentrée scolaire et les bourses", "Non, aucune aide n'existe", "Oui, mais elles sont réservées aux familles nombreuses", "Oui, versées uniquement par les communes"],
    a: 0,
  ...
  },
  {
    ...
    c: ["est proposé dans le cadre du contrat d'intégration républicaine signé avec l'OFII", "est réservé aux étudiants régulièrement inscrits dans une université française", "n'existe pas en France : chacun apprend par ses propres moyens", "est uniquement payant, dans des écoles de langue privées"],
    a: 0,
...
const travail = [
  {
    ...
    c: ["Le salaire minimum légal, en dessous duquel un employeur ne peut pas payer", "Le salaire moyen constaté chez les salariés français à temps plein", "Une prime de fin d'année versée par toutes les entreprises", "Un impôt prélevé chaque mois sur les salaires"],
    a: 0,
  ...
  },
  {
    ...
    c: ["Le CDI est à durée indéterminée, le CDD a une date de fin", "Le CDI est réservé aux cadres", "Le CDD ne donne droit à aucun salaire minimum garanti", "Le CDI ne peut jamais être rompu"],
    a: 0,
  ...
  },
  {
    ...
    c: ["France Travail", "La CAF, allocations familiales", "L'URSSAF", "La CPAM"],
    a: 0,
  ...
  },
  {
    ...
    c: ["la protection sociale : santé, retraite, famille, chômage", "les dépenses militaires et la défense du territoire national", "l'entretien des routes et des ponts du pays", "le budget de fonctionnement des communes"],
    a: 0,
  ...
  },
  {
    ...
    c: ["Oui : la liberté syndicale est garantie et ne peut pas être sanctionnée", "Non, l'adhésion à un syndicat est décidée par l'employeur", "Oui, mais uniquement dans les entreprises de plus de cinquante salariés", "Non, les syndicats sont interdits dans le secteur privé"],
    a: 0,
  ...
  },
  {
    ...
    c: ["disposer d'un titre de séjour l'autorisant à travailler", "seulement avoir signé un contrat de travail", "obtenir l'accord écrit du maire de la commune où il réside", "être inscrit dans une université française"],
    a: 0,
...
const quotidien = [
  {
    ...
    c: ["À la mairie du lieu de naissance", "À la préfecture du département", "Au tribunal", "Au commissariat"],
    a: 0,
  ...
  },
  {
    ...
    c: ["Un lieu d'accueil de proximité qui aide dans les démarches administratives", "Une agence immobilière publique qui attribue les logements sociaux", "Un service de police chargé de l'accueil des étrangers", "Une école de langue gratuite ouverte à tous"],
    a: 0,
  ...
  },
  {
    ...
    c: ["Par prélèvement à la source, directement sur le salaire ou la pension", "Uniquement par chèque en fin d'année", "Par prélèvement trimestriel obligatoire effectué en mairie", "Ils ne sont plus prélevés"],
    a: 0,
  ...
  },
  {
    ...
    c: ["À financer les services publics : école, santé, sécurité, justice, transports", "À rémunérer les élus de la République ainsi que leurs collaborateurs", "À rembourser les dettes des particuliers en difficulté", "À financer les partis politiques"],
    a: 0,
  ...
  },
  {
    ...
    c: ["Respecter le délai de préavis et prévenir le propriétaire par écrit", "Partir sans prévenir", "Demander l'autorisation de la mairie de sa commune", "Trouver lui-même un nouveau locataire avant de quitter les lieux"],
    a: 0,
  ...
  },
  {
    ...
    c: ["En déposant une demande de logement social qui donne un numéro unique d'enregistrement", "En s'adressant directement au bailleur ou au voisin qui déménage", "En payant une caution à la mairie", "Ce n'est pas possible pour les étrangers, même en situation régulière en France"],
    a: 0,
  ...
  },
  {
    ...
    c: ["Un permis de conduire valide, une assurance et un contrôle technique à jour", "Seulement une assurance", "Seulement le permis de conduire, en cours de validité en France", "Aucun document particulier si le trajet est court"],
    a: 0,
  ...
  },
  {
    ...
    c: ["Une amende, après intervention de la police ou de la gendarmerie", "Rien, le bruit n'est pas réglementé", "Une expulsion immédiate du logement, sans jugement", "Une peine de prison ferme, appliquée de façon systématique"],
    a: 0,
  ...
  },
  {
    ...
    c: ["En déposant une demande en mairie équipée, après pré-demande en ligne", "En s'adressant au commissariat de police du domicile", "En écrivant directement au président de la République française", "Auprès de son employeur"],
    a: 0,
  ...
  },
  {
    ...
    c: ["S'inscrire à la mairie de sa commune de résidence", "Contacter directement le rectorat", "S'adresser à la préfecture", "Attendre une convocation envoyée par l'école"],
    a: 0,
  ...
  },
  {
    ...
    c: ["est libre et non rémunéré, et constitue une forme d'engagement citoyen", "est obligatoire pour les personnes récemment naturalisées françaises", "est réservé aux retraités", "donne droit à un salaire minimum versé par l'association"],
    a: 0,
  ...
  },
  {
    ...
    c: ["Les services publics fonctionnent de façon régulière, sans interruption injustifiée", "Les services publics restent ouverts jour et nuit, sans aucune exception", "Les agents des services publics ne peuvent jamais faire grève", "Les services publics sont gratuits pour tous les usagers"],
    a: 0,
  ...
  },
  {
    ...
    c: ["déposer une réclamation, saisir un médiateur ou le Défenseur des droits", "refuser de payer ses impôts jusqu'à obtenir réparation", "porter plainte devant le tribunal de commerce du département", "exiger le licenciement de l'agent"],
    a: 0,
  ...
  },
  {
    ...
    c: ["est un droit garanti par la procédure de droit au compte, via la Banque de France", "se fait obligatoirement en préfecture, sur présentation d'un justificatif", "est réservée aux citoyens français et aux résidents de longue durée", "nécessite de justifier d'un revenu mensuel minimum"],
    a: 0,
