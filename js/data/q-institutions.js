...
const vote = [
  ...
  },
  {
    ...
    c: [
      ...
      "Avoir effectué son service militaire",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "Les citoyens français et les citoyens de l'Union européenne résidant dans la commune",
      "Uniquement les citoyens français",
      "Tous les résidents étrangers",
      "Uniquement les propriétaires de la commune",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "Non, il peut être conseiller municipal mais pas maire ni adjoint",
      "Oui, sans condition",
      "Oui, après cinq ans de résidence",
      "Non, il ne peut pas être conseiller municipal",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "La possibilité de faire voter une autre personne à sa place quand on est absent",
      "Un bulletin envoyé par courrier",
      "Une autorisation de voter deux fois",
      "Un vote effectué par internet",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "Une consultation où les citoyens répondent directement par oui ou par non à une question",
      "Une élection de députés",
      "Un sondage d'opinion officiel",
      "Un vote réservé au Parlement",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "Le pouvoir appartient au peuple, qui l'exerce par ses représentants ou par référendum",
      "Le pouvoir appartient à un seul homme",
      "Le pouvoir appartient aux plus riches",
  ...
  },
  {
    q: "Le vote a lieu :",
    c: [
      "dans un bureau de vote, après passage par l'isoloir",
  ...
  },
  {
    ...
    c: [
      "Le Conseil constitutionnel, qui veille à la régularité du scrutin et proclame les résultats",
      "Le Sénat",
      "Le Conseil d'État",
...
const organisation = [
  ...
  {
    q: "Où siège le Sénat ?",
    c: ["Au Palais du Luxembourg", "Au Palais Bourbon", "Au Palais-Royal", "À l'Hôtel de Ville"],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "La dissoudre et provoquer de nouvelles élections",
  ...
  },
  {
    ...
    c: [
      "Un vote de l'Assemblée nationale qui peut renverser le Gouvernement",
      "Une sanction contre un député",
      "Une décision du Conseil constitutionnel",
      "Un veto du président de la République",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "Il est élu par le conseil municipal, lui-même élu par les habitants",
      "Il est nommé par le préfet",
      "Il est élu directement par les habitants",
  ...
  },
  {
    ...
    c: [
      "Célébrer les mariages et enregistrer les naissances et les décès",
      "Juger les petits délits",
      "Délivrer les titres de séjour",
      "Fixer le montant des impôts nationaux",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: ["Le Congrès, réuni à Versailles", "La Convention", "Le Sénat élargi", "L'Assemblée constituante"],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "Défendre les personnes dont les droits ne sont pas respectés, notamment face aux administrations",
...
const europe = [
  ...
  },
  {
    ...
    c: [
      "Oui, dès la CECA en 1951 et le traité de Rome en 1957",
      "Non, elle a adhéré en 1973",
      "Non, elle a adhéré en 1986",
      "Oui, mais seulement depuis 1992",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: ["Depuis le 1er janvier 2002", "Depuis 1999", "Depuis 1995", "Depuis 2010"],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "Non, seuls les États de la zone euro l'utilisent",
      "Oui, c'est obligatoire pour tous",
      "Non, aucun pays de l'Est ne l'utilise",
      "Oui, depuis 2002",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "Douze étoiles d'or en cercle sur fond bleu, symbole d'unité et de perfection",
      "Une étoile par État membre",
      "Vingt-sept étoiles sur fond bleu",
      "Trois bandes bleu, blanc, jaune",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "L'Ode à la joie, extraite de la 9e symphonie de Beethoven",
      "La Marseillaise",
      "L'Hymne à l'amour",
      "Le Boléro de Ravel",
    ],
  ...
  },
  {
    ...
    c: [
      "À Strasbourg pour les sessions plénières",
      "À Paris",
      "À Bruxelles uniquement",
      "À Luxembourg uniquement",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "Un espace de libre circulation sans contrôle aux frontières intérieures",
      "La zone d'utilisation de l'euro",
  ...
  },
  {
    ...
    c: [
      "Circuler, résider et travailler dans un autre État membre, et voter aux élections municipales et européennes du pays de résidence",
      "Obtenir automatiquement la nationalité d'un autre État membre",
      "Payer ses impôts dans le pays de son choix",
      "Être dispensé de titre de séjour dans le monde entier",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "Non, c'est une organisation distincte, siégeant à Strasbourg, qui protège les droits de l'homme",
      "Oui, c'est son organe exécutif",
      "Oui, c'est son assemblée parlementaire",
      "Non, il siège à Bruxelles et gère l'euro",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "Elle est membre permanent du Conseil de sécurité avec droit de veto",
      "Elle est simple membre de l'Assemblée générale",
      "Elle en est le siège principal",
