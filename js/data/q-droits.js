...
const droits = [
  ...
  },
  {
    ...
    c: [
      "Un contrat d'union civile entre deux personnes majeures",
  ...
  },
  {
    ...
    c: [
      "Non : l'injure, la diffamation, l'incitation à la haine et l'apologie du terrorisme sont punies",
      "Oui, sans aucune limite",
      "Oui, sauf à la télévision",
      "Non, il faut une autorisation préfectorale pour s'exprimer publiquement",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "un droit reconnu par le préambule de la Constitution de 1946",
      "interdit dans le secteur privé",
      "réservé aux syndicats",
      "soumis à l'autorisation de l'employeur",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "Toute personne est considérée comme innocente tant que sa culpabilité n'a pas été établie par un tribunal",
      "L'accusé doit prouver son innocence",
      "Le juge doit croire l'accusé sur parole",
      "Un accusé ne peut jamais être placé en détention",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "d'être assistée par un avocat et d'être jugée équitablement",
      "de refuser de comparaître devant un tribunal",
      "de choisir son juge",
      "de connaître à l'avance la décision du tribunal",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: ["24 heures, renouvelable une fois", "48 heures", "12 heures", "72 heures"],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "Plus de vingt critères, dont l'origine, le sexe, la religion, le handicap et l'âge",
      "Trois critères seulement",
      "Aucun : la discrimination n'est pas définie par la loi",
      "Uniquement l'origine et la religion",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "Une journée obligatoire d'information sur la défense, pour les jeunes de 16 à 25 ans",
      "Un service militaire de dix mois",
      "Une journée de vote obligatoire",
  ...
  },
  {
    ...
    c: [
      ...
      "Uniquement les juristes",
      "Les personnes qui se portent volontaires",
      "Les élus locaux",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "On ne peut pas invoquer sa méconnaissance de la loi pour échapper à son application",
      "Tout le monde doit apprendre le Code civil par cœur",
      "Les étrangers ne sont pas soumis à la loi française",
      "La loi ne s'applique qu'à ceux qui l'ont lue",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "protège les personnes persécutées dans leur pays en raison de leurs opinions ou de leur appartenance",
      "est accordé à toute personne qui en fait la demande",
      "est réservé aux ressortissants européens",
  ...
  },
  {
    ...
    c: [
      ...
      "Une carte d'électeur européenne",
      "Un livret militaire",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "par filiation, par naissance et résidence en France, par mariage ou par naturalisation",
      "uniquement par la naissance sur le territoire",
      "uniquement par décret du président",
      "uniquement par le mariage",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "chacun peut se déplacer et choisir son lieu de résidence sur le territoire",
      "il faut une autorisation pour changer de département",
      "les déplacements sont libres uniquement le week-end",
      "seuls les citoyens français peuvent se déplacer librement",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "protégé par la Déclaration de 1789, sous réserve de l'expropriation pour utilité publique avec indemnisation",
      "absolu et sans aucune limite",
      "réservé aux citoyens français",
      "interdit pour les terrains agricoles",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "Le droit de protéger son intimité, son image et ses données personnelles",
      "Le droit de ne pas payer d'impôts",
      "Le droit de refuser un contrôle d'identité",
      "Le droit de ne pas déclarer son domicile",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "Lui porter secours ou alerter les services d'urgence",
      "Attendre l'arrivée spontanée des secours",
      "Filmer la scène pour témoigner",
      "S'éloigner pour ne pas gêner",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "des infractions pénales graves, punies même si elles sont commises à l'étranger",
      "tolérés s'ils relèvent d'une tradition familiale",
      "des pratiques autorisées avec l'accord des parents",
      "des affaires relevant du droit du pays d'origine",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "en commun par les deux parents, dans l'intérêt de l'enfant",
      "par le père seul",
      "par la mère seule jusqu'à la majorité",
      "par le grand-parent le plus âgé",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "Elle a valeur constitutionnelle et consacre le droit de vivre dans un environnement équilibré",
      "C'est une simple déclaration d'intention",
      "C'est un règlement européen",
      "C'est une loi ordinaire abrogée depuis",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "s'impose à toute personne vivant sur le territoire, française ou étrangère",
      "ne concerne que les citoyens français",
      "peut être écarté au nom d'une conviction religieuse",
  ...
  },
  {
    ...
    c: [
      "Protéger les données personnelles et la vie privée dans le numérique",
      "Contrôler les comptes de l'État",
  ...
  },
  {
    ...
    c: [
      "Tous les usagers sont traités de la même manière, sans privilège ni discrimination",
      "Les services publics sont gratuits pour tous",
      "Chacun peut choisir l'agent qui le reçoit",
      "Les usagers prioritaires sont désignés par le maire",
    ],
    a: 0,
  ...
  },
  {
    ...
    c: [
      "Non, la salariée enceinte bénéficie d'une protection particulière",
      "Oui, s'il la remplace immédiatement",
      "Oui, pendant la période d'essai uniquement",
      "Oui, dans les entreprises de moins de 20 salariés",
    ],
    a: 0,
